...
#oauth2 es un metodo de autenticacion para dos sistemas
#con una tecnica de seguridad
...
#es lo que espero como respuesta
async def auth_callback_google(request: Request):
    ...
    #post al que creamos de google client
    ...
    access_token = token_response_data["access_token"]
                                                                                #bearer es un metodo de autorizacion
